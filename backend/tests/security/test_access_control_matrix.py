...
EXPECTED_API_ENDPOINTS = {
    ...
    ("DELETE", "/api/auths/{auth_id}/clinical-assessments/{assessment_id}"),
    ("DELETE", "/api/auths/{auth_id}/documents/{document_id}"),
    ("DELETE", "/api/auths/{auth_id}/events/{event_id}"),
    ("DELETE", "/api/auths/{auth_id}/loc-episodes/{episode_id}"),
    ...
    ("GET", "/api/auths/{auth_id}/clinical-assessments"),
    ("GET", "/api/auths/{auth_id}/decision-snapshots"),
    ("GET", "/api/auths/{auth_id}/documents"),
    ("GET", "/api/auths/{auth_id}/documents/{document_id}/pdf"),
    ("GET", "/api/auths/{auth_id}/events"),
    ("GET", "/api/auths/{auth_id}/loc-episodes"),
    ("GET", "/api/governance/attestations"),
    ...
    ("PATCH", "/api/auths/{auth_id}/clinical-assessments/{assessment_id}"),
    ("PATCH", "/api/auths/{auth_id}/events/{event_id}"),
    ("PATCH", "/api/auths/{auth_id}/loc-episodes/{episode_id}"),
    ...
    ("POST", "/api/auths"),
    ("POST", "/api/auths/{auth_id}/clinical-assessments"),
    ("POST", "/api/auths/{auth_id}/decision-snapshots"),
